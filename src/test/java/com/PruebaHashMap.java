...
public class PruebaHashMap {private MapsImplementations hashMapImplementation;

    @Before
    public void setUp() throws IOException {
        // Creamos una instancia de HashMapImplementation utilizando MapFactory
        hashMapImplementation = MapFactory.createMapImplementation(1);
    }
